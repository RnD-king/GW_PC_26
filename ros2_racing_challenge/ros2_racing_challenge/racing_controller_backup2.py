...
class RacingController(Node):
    ...
    def _configure_controller(self) -> None:
        ...
        self.heading_gain = 1.713491
        self.lateral_gain = 1.384947
        self.steering_servo_gain = 6.134270
        self.speed_gain = 2.446210
        ...
        self.longitudinal_grip_reserve = 0.08
        self.preview_brake_accel = 5.45
        self.feedback_curvature_weight = 0.0 # 0.209600
        self.tire_force_usage_limit = 1.08
        self.motion_filter_alpha = 0.489172
        self.large_lateral_error_threshold = 0.85
        self.large_heading_error_threshold = 0.95
        self.large_error_speed_scale = 0.88
        self.medium_lateral_error_threshold = 0.58
        self.medium_heading_error_threshold = 0.55
        self.medium_error_speed_scale = 0.94
        self.small_lateral_error_threshold = 0.36
        self.small_heading_error_threshold = 0.30
        self.small_error_speed_scale = 0.98
        self.high_steering_threshold = 0.56 # 0.546430
        self.high_steering_speed_cap = 6.70
        self.medium_steering_threshold = 0.519309
        self.medium_steering_speed_cap = 7.35
        ...
        self.first_obstacle_relaxation_offset = 0.24
        self.first_obstacle_relaxation_center = 31.25
        self.first_obstacle_relaxation_width = 3.2
        self.bottom_straight_relaxation_offset = 0.10
        ...
        self.finish_shortcut_full_progress = 57.5
...
#             -1.545608950760,
#         ]
#         self.heading_gain = 1.763532
#         self.lateral_gain = 1.441716
#         self.steering_servo_gain = 6.497552
#         self.speed_gain = 2.243364
#         self.aggressive_lateral_usage_threshold = -1.0
#         self.aggressive_steering_threshold = 0.32
#         self.aggressive_accel_gain_scale = 1.0
#         self.aggressive_decel_gain_scale = 1.0
...
#         self.minimum_surface_multiplier = 0.85
#         self.next_lap_friction_preview_distance = 1.895927
#         self.longitudinal_grip_reserve = 0.075148
#         self.preview_brake_accel = 5.482148
#         self.feedback_curvature_weight = 0.0 # 0.209600
#         self.tire_force_usage_limit = 1.067415
#         self.motion_filter_alpha = 0.461690
#         self.large_lateral_error_threshold = 0.885978
#         self.large_heading_error_threshold = 0.921716
#         self.large_error_speed_scale = 0.854367
#         self.medium_lateral_error_threshold = 0.647877
#         self.medium_heading_error_threshold = 0.569784
#         self.medium_error_speed_scale = 0.950874
#         self.small_lateral_error_threshold = 0.360705
#         self.small_heading_error_threshold = 0.312306
#         self.small_error_speed_scale = 0.981999
#         self.high_steering_threshold = 0.567789
#         self.high_steering_speed_cap = 6.664909
#         self.medium_steering_threshold = 0.527125
#         self.medium_steering_speed_cap = 7.536481
#         self.first_lap_start_cap_distance = 0.0
#         self.first_lap_start_speed_cap = 9.0
#         self.low_grip_recovery_surface = 0.84 # 0.85
#         self.optimized_reference_blend = 1.0
